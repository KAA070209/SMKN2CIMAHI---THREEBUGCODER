    ...
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      @media (prefers-reduced-motion: reduce) {
        .bk-float-dot, .bk-toast-in, .bk-badge-pop, .bk-dropdown-in, .bk-auth-art-panel, .bk-auth-form-content, .bk-auth-modal-overlay, .bk-auth-modal, .bk-voucher-overlay, .bk-voucher-modal, .bk-review-track, .bk-review-detail-overlay, .bk-review-detail-modal, .bk-caret { animation: none !important; }
